...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {"NAME": "users.password_validation.PasswordComplexityValidator"},
...
AUTH_REFRESH_COOKIE_SAMESITE = env_str("AUTH_REFRESH_COOKIE_SAMESITE", "Lax")
...
if AUTH_REFRESH_COOKIE_SAMESITE not in {"Lax", "Strict", "None"}:
    raise ImproperlyConfigured("AUTH_REFRESH_COOKIE_SAMESITE musi mieć wartość Lax, Strict albo None.")

if AUTH_REFRESH_COOKIE_SAMESITE == "None" and not AUTH_REFRESH_COOKIE_SECURE:
    raise ImproperlyConfigured("AUTH_REFRESH_COOKIE_SECURE musi być włączone przy AUTH_REFRESH_COOKIE_SAMESITE=None.")
